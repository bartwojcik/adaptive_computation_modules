...
from .noise import BaseNoiseDistribution
from .target import BaseTargetDistribution, TargetDistribution
...
def aimle(function: Optional[Callable[[Tensor], Tensor]] = None,
    ...
    Example::
        ...
        >>> from aimle.aimle import aimle
        >>> from aimle.target import TargetDistribution
        >>> from aimle.noise import SumOfGammaNoiseDistribution
